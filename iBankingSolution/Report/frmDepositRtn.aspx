<%@ Page Language="C#" MasterPageFile="~/MasterPages/ProjectBM.Master" AutoEventWireup="true" CodeBehind="frmDepositRtn.aspx.cs" Inherits="iBankingSolution.Report.frmDepositRtn" %>
    ...
    <div class="row"><br />
     ...
     <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading" style="font-size:larger;">
                    <asp:Label ID="Label2" runat="server" Text="Deposit Return Settings"></asp:Label>
                </div>
                <div class="panel-body">
                    ...
                    <div style="overflow: scroll;">
                        ...
                        <asp:GridView ID="gridSettings" runat="server" AutoGenerateColumns="False" EmptyDataText="No Data Found" DataKeyNames="R_ID"  BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Width="1276px">
                            <Columns>
                                <%--<asp:BoundField DataField="LSL" HeaderText="Sl" HeaderStyle-Width="100px">
                                    <HeaderStyle Width="100px"></HeaderStyle>
                                </asp:BoundField> OnRowCommand="gridSettings_RowCommand" OnRowDeleting="gridSettings_RowDeleting"
