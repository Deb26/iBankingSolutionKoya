<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind="FrmBalanceSheetReport.aspx.cs" Inherits="iBankingSolution.Report.FrmBalanceSheetReport" %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:DropDownList ID="ddlExportReport" runat="server" CssClass="form-control" Font-Size="10" class="styled-select" BackColor="White" ForeColor="Black">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTablesexample">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblLeftcurrent" runat="server" Text="" style="font-weight: 700"></asp:Label></td>
                                    <td><asp:Label ID="lblLeftprevious" runat="server" Text="" style="font-weight: 700"></asp:Label></td>
                                    ...
                                    <td><strong><asp:Label ID="lblRightcurrent" runat="server" Text="" style="font-weight: 700"></asp:Label></strong></td>
                                    <td><strong><asp:Label ID="lblRightprevious" runat="server" Text="" style="font-weight: 700"></asp:Label></strong></td>
