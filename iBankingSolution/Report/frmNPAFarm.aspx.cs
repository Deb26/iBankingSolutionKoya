...
{
    public partial class frmNPAFarm : System.Web.UI.Page
    {
        ...
        protected void FillReportByType()
        {
            ...
            foreach (DataRow dr in dt.Tables[0].Rows)
            {
                ...
                if (ODDT1 > ODDT)
                {
                    dr["overduedt"] = ODDT1.AddMonths(24);

                    DateTime ot = ODDT1.AddMonths(24);
                ...
                {
                    dr["overduedt"] = ODDT.AddMonths(24);
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            dt = (DataTable)System.Web.HttpContext.Current.Session["dtNPAFarm"];
            if (dt.Rows.Count > 0)
            {
                    Response.Clear();
