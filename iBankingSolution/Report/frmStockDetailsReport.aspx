<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind="frmStockDetailsReport.aspx.cs" Inherits="iBankingSolution.Report.frmStockDetailsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="clearfix"></div>
                                   ...
                                   <div class="col-md-2">
                                        <label style="margin-right: 20PX;">Category</label>
                                          ...
                                          <asp:DropDownList ID="cmbx_Category" runat="server" CssClass="form-control"></asp:DropDownList>
                                    ...
                                    <div class="col-md-2">
                                        <label style="margin-right: 20PX;">AsOn Date:</label>
        ...
        <div>
            <center>
            <asp:GridView ID="GvStockDetails" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" ShowFooter="True" Width="70%" OnPageIndexChanging="GvStockDetails_PageIndexChanging" Font-Names="Verdana" Font-Size="Small">
