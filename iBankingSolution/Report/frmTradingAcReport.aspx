<%@ Page Language="C#" MasterPageFile="~/MasterPages/ProjectBM.Master" AutoEventWireup="true" CodeBehind="frmTradingAcReport.aspx.cs" Inherits="iBankingSolution.Report.frmTradingAcReport" %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:DropDownList ID="ddlExportReport" runat="server" Font-Size="10" CssClass="form-control" class="styled-select" BackColor="White" ForeColor="Black">
