<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master"  CodeBehind="frmGSTCalculation.aspx.cs" Inherits="iBankingSolution.Report.frmGSTCalculation" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="cmbx_transtype" runat="server" CssClass="form-control">
                                ...
                                <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="cmbxGroupName" runat="server" CssClass="form-control">

                                        </asp:DropDownList>
                                 </div>

                                  <div class="col-md-2">
                                        <label style="margin-right: 20PX;">GST%:</label>

                                        <asp:DropDownList ID="CmbxGST" runat="server" CssClass="form-control">
