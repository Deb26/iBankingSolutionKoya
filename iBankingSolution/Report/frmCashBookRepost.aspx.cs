...
{
    public partial class frmCashBookRepost : System.Web.UI.Page
    {
        ...
        protected void GenerateCashBook()
        {
            ...
            //    objBO_Finance.BranchCode = cmbx_Branch.SelectedValue;
            //}
            DataSet dtDayBook = objBL_Finance.CashBookReport(objBO_Finance, out SQLError); //DATA LAYER
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            if (dtpkr_DateAsOn.Text != "")
            {
                ...
                {
                    string url = "../ExportDownloadPage/ExportToCashBookReport.aspx?ID=" + ddlExportReport.SelectedItem.Text;
