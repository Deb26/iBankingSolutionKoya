...
{
    public partial class frmSalesJournalReport : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string path = Server.MapPath(@"../Report/CrystalReports/StockJournalReport.rpt");
                crystalReport.Load(Server.MapPath(@"../Report/CrystalReports/StockJournalReport.rpt"));
                crystalReport.FileName = Server.MapPath(@"../Report/CrystalReports/StockJournalReport.rpt");

                crystalReport.SetDatabaseLogon(builder.UserID, builder.Password, builder.InitialCatalog, builder.DataSource);
                crystalReport.SetDataSource(dt);
                crystalReport.ExportToHttpResponse(ExportFormatType.RichText, Response, true, "StockJournalReport");
                Response.End();
