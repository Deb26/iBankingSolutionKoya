...
{
    public partial class frmLoanSecKVPNSC : System.Web.UI.Page
    {
        ...
        protected void cmbx_slcode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dt = objBL_Finance.LoanSecurityKVPNSCReport(objBO_Finance);
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            if (cmbx_slcode.SelectedItem.Text != "")
            {
                ...
                dt = (DataTable)System.Web.HttpContext.Current.Session["dtKvpNsc"];
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    crystalReport.Load(Server.MapPath(@"~/Report/CrystalReports/rptLoanSecKVPNSC.rpt"));
                    crystalReport.FileName = Server.MapPath(@"~/Report/CrystalReports/rptLoanSecKVPNSC.rpt");

                    crystalReport.SetDatabaseLogon(builder.UserID, builder.Password, builder.InitialCatalog, builder.DataSource);
                    crystalReport.SetDataSource(dt);
                    //crystalReport.SetDataSource(ds);

                    crystalReport.ExportToHttpResponse(ExportFormatType.RichText, Response, true, "KvpNsc");
