                ...
                <div class="panel panel-primary">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            <td>CustID:</td>
                            <td colspan="4" cssc>
                                <asp:TextBox ID="txtCustID" runat="server" CssClass="form-control" AutoPostBack="True" OnTextChanged="txtCustID_TextChanged" placeholder="ENTER CUST_ID" Font-Size="10"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnshow" runat="server" Text="ShowReport" class="btn btn-primary" OnClick="btnshow_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnReset" runat="server" Text="Reset" class="btn btn-primary" />
                            </td>
                            <td>
