...
{
    public partial class StockMemoDetailsReport : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string path = Server.MapPath(@"../Report/CrystalReports/StockMemoDetailsRPT.rpt");
                crystalReport.Load(Server.MapPath(@"../Report/CrystalReports/StockMemoDetailsRPT.rpt"));
                crystalReport.FileName = Server.MapPath(@"../Report/CrystalReports/StockMemoDetailsRPT.rpt");

                crystalReport.SetDatabaseLogon(builder.UserID, builder.Password, builder.InitialCatalog, builder.DataSource);
                crystalReport.SetDataSource(dt);
                crystalReport.ExportToHttpResponse(ExportFormatType.RichText, Response, true, "StockMemoDetailsReport");
                Response.End();
