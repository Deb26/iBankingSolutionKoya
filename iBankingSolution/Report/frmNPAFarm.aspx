<%@ Page Language="C#" MasterPageFile="~/MasterPages/ProjectBM.Master" AutoEventWireup="true" CodeBehind="frmNPAFarm.aspx.cs" Inherits="iBankingSolution.Report.frmNPAFarm" %>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTablesexample">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Current Overdue Upto 2 Years</th>
