<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind="frmItemClassList.aspx.cs" Inherits="iBankingSolution.Master.frmItemClassList" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="float: right; margin-top: 12px;">
                    <a href="~/Master/FrmItemClass.aspx" id="add" runat="server" class="btn btn-primary">Add New</a>
                </div>
                <h1 class="page-header">Item Class List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
