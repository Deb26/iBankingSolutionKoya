        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="float: right; margin-top: 12px;">
                    ...
                    <a href="frmItemClassList.aspx" class="btn btn-default">Back to List</a>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <asp:TextBox ID="txtItemName" runat="server" placeholder="Enter Item Name" Font-Size="10" CssClass="form-control" />
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SL." HeaderStyle-HorizontalAlign="Left">
                                                      ...
                                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Item code">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtItmClassCode" CssClass="form-control input-sm" runat="server" placeholder="ENTER ITEM CLASS" Font-Size="10"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Item Name">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtUserName" CssClass="form-control input-sm" runat="server" placeholder="USER NAME" Font-Size="10"
