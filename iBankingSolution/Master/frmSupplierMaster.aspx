                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <asp:TextBox ID="txtsupplierName" runat="server" placeholder="ENTER Supplier Name" Font-Size="10"  CssClass="form-control" />
                                </div>
                                <div class="col-md-12">
                                    <label style="margin-right: 20PX;">Ledger</label>
                                   <asp:DropDownList ID="ddlLedger" runat="server" CssClass="form-control" Font-Size="10"></asp:DropDownList>
                                </div>
                                <div class="col-md-12">
                                    <label style="margin-right: 20PX;">Address</label>
                                  <asp:TextBox ID="txtAddress" runat="server" placeholder="ENTER ADDRESS" Font-Size="10"  CssClass="form-control" TextMode="MultiLine"/>
                                </div>
                                <div class="col-md-4">
                                    <label style="margin-right: 20PX;">Opening Balance</label>
                                    <asp:TextBox ID="txtOpeningBalance" runat="server" placeholder="ENTER OPENING BALANCE" Font-Size="10"  CssClass="form-control" />
                                </div>
                                <div class="col-md-4">
                                    <label style="margin-right: 20PX;">Debit</label>
                                    <asp:RadioButton ID="rbDebit" runat="server" placeholder="ENTER DEBIT AMT" Font-Size="10" CssClass="form-control"/>
                                </div>
                                <div class="col-md-4">
                                    <label style="margin-right: 20PX;">Credit</label>
                                  
                                      <asp:RadioButton ID="rbCredit" placeholder="ENTER CREDIT AMT" Font-Size="10" runat="server" CssClass="form-control"/>
                                </div>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SL." HeaderStyle-HorizontalAlign="Left">
                                                      ...
                                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Item code">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtsupplierCode" CssClass="form-control input-sm" runat="server" placeholder="ENTER SUPP CODE" Font-Size="10"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Supplier Name">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtUserName" CssClass="form-control input-sm" runat="server" placeholder="ENTER SUPPLIER NAME" Font-Size="10"
