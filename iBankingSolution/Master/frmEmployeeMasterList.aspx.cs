...
{
    public partial class frmEmployeeMasterList : System.Web.UI.Page
    {
        ...
        protected void lnkedit_Click(object sender, EventArgs e)
        {
            ...
            int iStID = int.Parse((item.FindControl("lblEmpCode") as Label).Text);

            Response.Redirect("~/Master/frmEmployeeMaster.aspx?Id=" + iStID);
        }
        protected void LinkDelete_Click(object sender, EventArgs e)
        {
            ...
            if (i > 0)
            {
                ...
                RepCCList.DataSource = ViewState["EmployeeDetails"] = objBL_Finance.GetEmployeeMasterRecords(objBO_Finance, out SQLError);
                RepCCList.DataBind();
            }
            else
            {
