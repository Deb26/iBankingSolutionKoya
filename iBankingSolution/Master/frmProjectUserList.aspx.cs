...
{
    public partial class frmProjectUserList : System.Web.UI.Page
    {
        ...
        protected void lnkedit_Click(object sender, EventArgs e)
        {
            ...
            int iStID = int.Parse((item.FindControl("lblUser_Id") as Label).Text);

            Response.Redirect("~/Master/frmProjectUser.aspx?Id=" + iStID);
        }
        protected void LinkDelete_Click(object sender, EventArgs e)
        {
            ...
            if (i > 0)
            {
                ...
                RepCCList.DataSource = ViewState["LoanSchemeDetails"] = objBL_Finance.GetLoanSchemeMasterRecords(objBO_Finance, out SQLError);
                RepCCList.DataBind();
            }
            else
            {
