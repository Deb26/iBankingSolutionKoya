...
{
    public partial class frmSHGAccountOpeningList : System.Web.UI.Page
    {
        ...
        protected void BindGrid()
        {
            ...
            DataSet dt = objBL_Finance.GetAccountListShg(objBO_Finance, out SQLError);
        ...
        protected void lnkedit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Transaction/frmSHGAccountOpening.aspx?Id=" + iStID);
        }
