<%@ Page Language="C#" MasterPageFile="~/MasterPages/ProjectBM.Master" AutoEventWireup="true" CodeBehind="frmShareAccountOpeningList.aspx.cs" Inherits="iBankingSolution.Transaction.frmShareAccountOpeningList" %>
    ...
    <div class="row">
            <div class="col-lg-12">
                <div style="float: right; margin-top: 12px;">
                    <a href="~/Transaction/frmShareAccountOpening.aspx" id="add" runat="server" class="btn btn-primary">Add New</a>
                </div>
                <h1 class="page-header">Share Account Opening List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
