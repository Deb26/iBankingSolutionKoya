<%@ Page Language="C#" MasterPageFile="~/MasterPages/ProjectBM.Master" AutoEventWireup="true" CodeBehind="frmVoucherModification.aspx.cs" Inherits="iBankingSolution.Transaction.frmVoucherModification" %>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:GridView ID="GVMTransaction" runat="server" AutoGenerateColumns="False" CellPadding="3" Height="188px" Width="1254px" ForeColor="#333333" CssClass="table table-bordered table-striped table-hover"
                                            EmptyDataText="No Data Found" GridLines="Both" 
                                             ShowFooter="True" OnRowDataBound="GVMTransaction_RowDataBound" DataKeyNames="CCBCodeNew">
                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="CCBCODE" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="LDG CODE" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_Ldg_Code" runat="server" Text='<%# Bind("[LDG_CODE]") %>' CssClass="form-control input-sm" AutoPostBack="True" OnTextChanged="txt_Ldg_Code_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" />
                                                     <HeaderStyle HorizontalAlign="Left" />
                                                    <%--  <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("[Leadger Code]") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="SL CODE" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_Sl_Code" runat="server" CssClass="form-control input-sm" Text='<%# Bind("[SL_CODE]") %>' AutoPostBack="True" OnTextChanged="txt_Sl_Code_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                     <ItemStyle HorizontalAlign="Left" />
                                                     <HeaderStyle HorizontalAlign="Left" />
                                                    <%-- <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("[Subledger Code]") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="AMOUNT DEBIT" HeaderStyle-HorizontalAlign="Left">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_Amt_Debit" runat="server" CssClass="form-control input-sm" Text='<%# Bind("[AMT_DEBIT]") %>' AutoPostBack="True" OnTextChanged="txt_Amt_Debit_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="AMOUNT CREDIT">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_Amt_Credit" runat="server" CssClass="form-control input-sm" Text='<%# Bind("[AMT_CREDIT]") %>' AutoPostBack="True" OnTextChanged="txt_Amt_Credit_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
