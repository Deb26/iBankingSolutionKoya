...
{
    public partial class ExportToCashBookReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    crystalReport.Load(Server.MapPath(@"~/Report/CrystalReports/NewDayBook.rpt"));
                    crystalReport.FileName = Server.MapPath(@"~/Report/CrystalReports/NewDayBook.rpt");
