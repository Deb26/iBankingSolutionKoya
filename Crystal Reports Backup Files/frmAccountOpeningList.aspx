<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind="frmAccountOpeningList.aspx.cs" Inherits="iBankingSolution.Transaction.frmAccountOpeningList" %>
    ...
    <form id="frmAcctOpeningDetails" runat="server">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Account Opening List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
