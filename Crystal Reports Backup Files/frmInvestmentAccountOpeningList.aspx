<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind="frmInvestmentAccountOpeningList.aspx.cs" Inherits="iBankingSolution.Transaction.frmInvestmentAccountOpeningList" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="float: right; margin-top: 12px;">
                    <a href="~/Transaction/FrmInvestmentAccountOpening.aspx" id="add" runat="server" class="btn btn-primary">Add New</a>
                </div>
                <h1 class="page-header">Investment Account Opening List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Investment Account Opening List                
                    </div>
