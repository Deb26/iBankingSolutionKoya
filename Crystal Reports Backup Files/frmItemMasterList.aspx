<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/ProjectBM.Master" CodeBehind ="frmItemMasterList.aspx.cs" Inherits="iBankingSolution.Master.frmItemMasterList" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="float: right; margin-top: 12px;">
                    <a href="~/Master/FrmItemMaster.aspx" id="add" runat="server" class="btn btn-primary">Add New</a>
                </div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblSchemeName" runat="server" Text='<%# Eval("Item_Name")%>'></asp:Label>
                                                
                                            </td>
                                             <td>

                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("MCLASS")%>'></asp:Label>
